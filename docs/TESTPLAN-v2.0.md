...
*   `cargo run -- --version` prints `ftime 2.0.0`.
*   After publishing `v2.0.0`, `scripts/install.sh` and `scripts/install.ps1` install a binary whose `--help` matches the v2 contract.
