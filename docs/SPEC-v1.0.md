# ftime v1.0.3 Behavior Specification
...
`-H/--hidden` is not part of the public v1.0.3 CLI contract.
...
*   v1.0.3 freezes the current public CLI contract for future compatibility.
*   The public v1.0.3 contract includes dotfiles by default and uses `--exclude-dots` as the opt-out flag.
