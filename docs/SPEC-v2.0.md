...
*   v2.0.0 is a breaking release relative to v1.x.
*   Removal of `-H/--hidden` and reversal of dotfile default behavior are intentional major-version changes.
