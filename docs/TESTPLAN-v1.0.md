...
*   `cargo run -- --version` prints `ftime 1.0.3`.
*   After publishing `v1.0.3`, the latest installer assets install a binary whose `--help` matches the v1 contract.
