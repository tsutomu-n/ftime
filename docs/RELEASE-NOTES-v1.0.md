...
- Clarified the product positioning of `ftime` as a read-only CLI for Context Recovery: it helps rebuild the recent working context of one folder before narrowing down what to inspect next.
